                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Downloads or streams video from YouTube with custom options.
                            </motion.p>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdSettingsVoice className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Custom Video</h3>
                                <p className="text-neutral-400">Download videos with custom resolution and filters</p>
                            </div>
                        </motion.div>
                    </div>
