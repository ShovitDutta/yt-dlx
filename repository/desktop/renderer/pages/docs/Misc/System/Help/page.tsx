                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Provides help information for yt-dlx. This function outputs a thank you message to the console and provides a link to the official yt-dlx documentation website via an
                                emitted event.
                            </motion.p>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdHelpOutline className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">System Help</h3>
                                <p className="text-neutral-400">Get help and documentation links</p>
                            </div>
                        </motion.div>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">No configuration options are required for this function.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3 pl-7 mt-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">On successful execution: The URL to the help documentation (string).</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="mt-1 mr-3 text-red-600 flex-shrink-0">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">Error message if an unexpected error occurs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
