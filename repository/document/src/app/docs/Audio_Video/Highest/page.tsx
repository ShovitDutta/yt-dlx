...
export default function AudioHighestDoc() {
    return (
                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Downloads or streams the highest quality audio from YouTube with filter options.
                            </motion.p>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                ...
                                <p className="text-neutral-400">Download the highest quality audio available</p>
                            </div>
                        </motion.div>
                    </div>
                                ...
                                <div className="space-y-3 pl-7">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            ...
                                            <p className="text-neutral-400 w-full">
                                                (Optional) A filter to potentially apply. Note: Actual application of filters might not work as expected.
                                                <span className="text-yellow-600">
                                                    Cannot be used with <code className="bg-neutral-800 px-1 py-0.5 rounded text-yellow-500 whitespace-pre-wrap">metadata: true</code>
                                                </span>
                                                .
