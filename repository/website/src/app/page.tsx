                    ...
                    <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[600px] text-white md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    Our extensive documentation provides detailed guides and tutorials to help you get the most out of YT-DLX. Whether you are a beginner or an advanced user, you wll
                    ...
                    <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
                        <div className="flex flex-col justify-center space-y-4">
                            <div className="space-y-2">
                                ...
                                <h2 className="text-3xl font-black tracking-tighter sm:text-7xl text-red-700">We are Here to Help</h2>
                                <p className="max-w-[600px] text-white md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
