...
export default function MiscVideoExtract() {
    return (
                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.h2 className="text-4xl font-bold sm:text-5xl lg:text-6xl text-red-600" {...FromLeftToRight}>
                                YtDlx.Misc.Video.Extract()
                            </motion.h2>
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Extracts comprehensive information about a YouTube video.
                            </motion.p>
                            <motion.div className="flex flex-wrap gap-3 mt-6" {...FadeIn}>
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Misc/Video/extract.test.ts", "_blank");
                                    }}>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Misc/Video/extract.test.js", "_blank");
                                    }}>
                                ...
                                <button
                                    className="inline-flex h-10 items-center justify-center rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 px-5 py-2 text-sm transition-all"
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Misc/Video/extract.test.mjs", "_blank");
                                    }}>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdInfo className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Video Information</h3>
                                <p className="text-neutral-400">Extract detailed metadata, formats, and more</p>
                            </div>
                        </motion.div>
                    </div>
                    <motion.div className="mt-8 w-full" {...AndBounce}>
                                ...
                                <div className="space-y-3 pl-7">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            ...
                                            <p className="text-neutral-400 w-full">(Optional) Whether to use Tor for certain requests.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="mt-1 mr-3 text-red-600 flex-shrink-0">
                        ...
                        <div className="bg-neutral-900 rounded-lg p-6 border border-neutral-800 mt-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-wrap w-full">
                                    <p className="text-neutral-300 w-full">An EventEmitter instance for handling events during the extraction process.</p>
                                </div>
                            </div>
                            <div className="space-y-3 pl-7 mt-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">On success: A comprehensive object with video formats, metadata, comments, and transcript.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="mt-1 mr-3 text-red-600 flex-shrink-0">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">Error message on failure.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
