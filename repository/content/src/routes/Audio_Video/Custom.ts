 ...
 *
 * @example
 * // 1. Download combined audio/video with a specific resolution using async/await syntax with try...catch
 * const query = "some video or query";
 * const resolution = "720p";
 * try {
 * const outputPath = await YouTubeDLX.Audio_Video.Custom({ query, resolution });
 ...
 *
 * @example
 * // 2. Stream combined audio/video with a specific resolution and verbose logging using async/await
 * const query = "another video or query";
 * const resolution = "1080p";
 * try {
 * const streamInfo = await YouTubeDLX.Audio_Video.Custom({ query, resolution, stream: true, verbose: true });
 ...
 * try {
 * const metadata = await YouTubeDLX.Audio_Video.Custom({ query, resolution, metadata: true });
 ...
 *
 * @example
 * // 4. Download combined audio/video with a filter and custom output directory using async/await
 * const query = "video with filter";
 * const resolution = "1080p";
 * try {
 * const outputPath = await YouTubeDLX.Audio_Video.Custom({ query, resolution, output: "./filtered_video_out", filter: "grayscale" });
