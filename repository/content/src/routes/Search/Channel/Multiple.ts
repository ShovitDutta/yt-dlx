// Suggestion: Add JSDoc comments to the functions, explaining their purpose, parameters, and return values. Also, the `channelSearchType` interface could benefit from JSDoc comments on its properties. Consider adding pagination to handle a large number of search results.
