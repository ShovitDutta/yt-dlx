...
export default function HomePage() {
  const functions = [
    ...
    },
    {
      ...
      description: "Searches for YouTube playlists based on a query string and returns the data of the first playlist found.",
    },
    {
      category: "Search",
      href: "/docs/Search/Playlist/Single",
      name: "YouTubeDLX.Search.Playlist.Single()",
      description: "Fetches data for a YouTube playlist. Retrieves details about a YouTube playlist, including its title, video count, and a list of videos within the playlist. Requires a valid YouTube playlist link as input.",
    },
    {
      category: "Search",
      href: "/docs/Search/Video/Multiple",
      name: "YouTubeDLX.Search.Video.Multiple()",
      description: "Searches for YouTube videos with filtering and sorting options.",
    },
    {
      category: "Search",
      href: "/docs/Search/Video/Single",
      name: "YouTubeDLX.Search.Video.Single()",
      description: "Fetches detailed data for a single YouTube video.",
    } /* Account Functions */,
    {
      category: "Account",
    ...
    } /* Misc Functions */,
    {
      ...
      description: "Provides help information for yt-dlx. This function outputs a thank you message to the console and provides a link to the official yt-dlx documentation website via an emitted event.",
    },
    {
      category: "Misc",
    ...
    },
    {
      ...
      description: "Extracts comprehensive information about a YouTube video.",
    },
    {
      category: "Misc",
      href: "/docs/Misc/Video/Related",
      name: "YouTubeDLX.Misc.Video.Related()",
      description: "Lists available audio and video formats for a YouTube video.",
    },
    {
      category: "Misc",
      href: "/docs/Misc/Video/Comments",
      name: "YouTubeDLX.Misc.Video.Comments()",
      description: "Fetches related videos for a given YouTube video ID.",
    },
    {
      category: "Misc",
