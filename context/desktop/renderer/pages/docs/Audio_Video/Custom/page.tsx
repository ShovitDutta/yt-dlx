                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.div className="flex flex-wrap gap-3 mt-6" {...FadeIn}>
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Audio_Video/custom.test.ts", "_blank");
                                    }}>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Audio_Video/custom.test.js", "_blank");
                                    }}>
                                ...
                                <button
                                    className="inline-flex h-10 items-center justify-center rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 px-5 py-2 text-sm transition-all"
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Audio_Video/custom.test.mjs", "_blank");
                                    }}>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdPlayCircleFilled className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Combined Audio/Video</h3>
                                <p className="text-neutral-400">Download or stream combined audio and video</p>
                            </div>
                        </motion.div>
                    </div>
                    <motion.div className="mt-8 w-full" {...AndBounce}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 pl-7">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <span className="font-semibold text-neutral-300">options.resolution</span>
                                            <p className="text-neutral-400 w-full">
                                                The desired video resolution. <span className="text-red-500">Required</span>.
                                            </p>
                                            <p className="text-neutral-500 mt-1 flex flex-wrap w-full">
                                                Available: <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;144p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;240p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;360p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;480p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;720p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;1080p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;1440p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;2160p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;3072p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;4320p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;6480p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded mr-1 text-green-400 whitespace-pre-wrap">&quot;8640p&quot;</code>
                                                <code className="bg-neutral-800 px-1 py-0.5 rounded text-green-400 whitespace-pre-wrap">&quot;12000p&quot;</code>
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                        ...
                        <div className="bg-neutral-900 rounded-lg p-6 border border-neutral-800 mt-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-wrap w-full">
                                    <p className="text-neutral-300 w-full">An EventEmitter instance for handling events during the audio/video processing.</p>
                                </div>
                            </div>
                            <div className="space-y-3 pl-7 mt-4">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full flex flex-wrap">
                                            Video metadata, formats, suggested filename.
