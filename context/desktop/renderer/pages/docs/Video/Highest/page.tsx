                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Downloads or streams the highest quality video from YouTube.
                            </motion.p>
                            <motion.div className="flex flex-wrap gap-3 mt-6" {...FadeIn}>
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Video/highest.test.ts", "_blank");
                                    }}>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Video/highest.test.js", "_blank");
                                    }}>
                                ...
                                <button
                                    className="inline-flex h-10 items-center justify-center rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 px-5 py-2 text-sm transition-all"
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Video/highest.test.mjs", "_blank");
                                    }}>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdVideoCameraFront className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Highest Quality Video</h3>
                                <p className="text-neutral-400">Download the highest quality video available</p>
                            </div>
                        </motion.div>
                    </div>
