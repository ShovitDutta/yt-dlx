                ...
                <div className="container px-4 md:px-6">
                    <form
                        ...
                        <motion.p className="mb-8 italic text-white font-semibold" {...FromBottomToTop}>
                            Unlock the power of YT-DLX, the ultimate node.js toolkit for seamless audio and video downloading and streaming. Effortlessly handle various coding flavors, from TypeScript
                            to CommonJS and ESM, ensuring 100% compatibility and comprehensive type safety.
                        </motion.p>
