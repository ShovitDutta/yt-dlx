...
var VideoOnly: React.FunctionComponent<input> = ({ isOpen, onClose, videoId }) => {
    ...
    var [formData, _formData] = React.useState({ metadata: false, verbose: true, useTor: true, stream: true });
    React.useEffect(() => {
                ...
                <motion.div
                    ...
                    <div
                        ...
                        <h2 className="text-7xl text-red-700 font-black mb-10">
                            Choose Your Poison For <br /> <span className="text-9xl block italic">Video</span>
                        </h2>
