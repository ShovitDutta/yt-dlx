                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.p className="text-gray-300 text-lg" {...AndBounce}>
                                Downloads or streams the lowest quality audio from YouTube.
                            </motion.p>
                            <motion.div className="flex flex-wrap gap-3 mt-6" {...FadeIn}>
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Audio/lowest.test.ts", "_blank");
                                    }}>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Audio/lowest.test.js", "_blank");
                                    }}>
                                ...
                                <button
                                    className="inline-flex h-10 items-center justify-center rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 px-5 py-2 text-sm transition-all"
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Audio/lowest.test.mjs", "_blank");
                                    }}>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                ...
                                <h3 className="text-xl font-semibold text-white mb-2">Lowest Quality Audio</h3>
                                <p className="text-neutral-400">Download the lowest quality audio available</p>
                            </div>
                        </motion.div>
                    </div>
                            ...
                            <div className="space-y-3 pl-7 mt-4">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full flex flex-wrap">
                                            Video metadata, lowest audio format, suggested filename.
