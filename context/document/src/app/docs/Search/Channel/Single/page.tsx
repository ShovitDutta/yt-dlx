...
export default function SearchChannelSingle() {
    return (
                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-start space-y-6">
                            ...
                            <motion.div className="flex flex-wrap gap-3 mt-6" {...FadeIn}>
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Search/Channel/single.test.ts", "_blank");
                                    }}>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Search/Channel/single.test.js", "_blank");
                                    }}>
                                ...
                                <button
                                    className="inline-flex h-10 items-center justify-center rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 px-5 py-2 text-sm transition-all"
                                    onClick={() => {
                                        window.open("https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Search/Channel/single.test.mjs", "_blank");
                                    }}>
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdAccountCircle className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Single Channel Search</h3>
                                <p className="text-neutral-400">Retrieve detailed information for a specific channel</p>
                            </div>
                        </motion.div>
                    </div>
                    <motion.div className="mt-8 w-full" {...AndBounce}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 pl-7">
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <span className="font-semibold text-neutral-300">options.channelLink</span>
                                            <p className="text-neutral-400 w-full">
                                                The link or ID of the YouTube channel. <span className="text-red-500">Required</span>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-neutral-900 rounded-lg p-6 border border-neutral-800 mt-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-wrap w-full">
                                    <p className="text-neutral-300 w-full">An EventEmitter instance for handling events during channel data fetching.</p>
                                </div>
                            </div>
                            <div className="space-y-3 pl-7 mt-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">On success: object containing detailed information about the channel.</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="mt-1 mr-3 text-red-600 flex-shrink-0">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">Error message if an error occurs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
