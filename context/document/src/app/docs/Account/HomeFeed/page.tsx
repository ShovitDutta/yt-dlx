                    ...
                    <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                        ...
                        <motion.div
                            ...
                            <div className="text-center p-6">
                                <MdHome className="w-24 h-24 text-red-600 mx-auto mb-4" />
                                <h3 className="text-xl font-semibold text-white mb-2">Home Feed</h3>
                                <p className="text-neutral-400">Fetch your YouTube home feed</p>
                            </div>
                        </motion.div>
                    </div>
                    <motion.div className="mt-8 w-full" {...AndBounce}>
                                ...
                                <div className="space-y-3 pl-7">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            ...
                                            <p className="text-neutral-400 w-full">(Optional) Specify how the home feed items should be sorted. Available:</p>
                        ...
                        <div className="bg-neutral-900 rounded-lg p-6 border border-neutral-800 mt-6">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-wrap w-full">
                                    <p className="text-neutral-300 w-full">An EventEmitter instance for handling events during home feed fetching.</p>
                                </div>
                            </div>
                            <div className="space-y-3 pl-7 mt-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="flex flex-wrap w-full">
                                        ...
                                        <p className="text-neutral-400 w-full">On success: object containing status and feed items (Shorts, Videos).</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="mt-1 mr-3 text-red-600 flex-shrink-0">
