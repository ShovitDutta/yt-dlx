        ...
        <motion.div className="mb-8 sticky top-0 z-50 py-4" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <GlassCard className="p-2 rounded-full border-2 border-red-800">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <select
                            className="px-4 py-3 rounded-r-full rounded-l-full bg-neutral-900/70 text-white border border-red-900 focus:outline-none focus:ring-2 focus:ring-red-500"
                            value={region}
