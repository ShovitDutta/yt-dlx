                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {searchResults.map(video => (
                        <motion.div key={video.videoId} className="bg-gray-800 rounded-md shadow-md p-4">
                            ...
                            <h3 className="text-lg font-semibold text-white">{video.title}</h3> <p className="text-gray-400">{video.authorName}</p>
    ...
    return (
        <div className="min-h-screen bg-gray-900 py-6 text-white">
            <div className="container mx-auto px-4">
                <SearchBar onSearch={handleSearch} /> <SearchResults searchResults={searchResults} isLoading={isSearchLoading} /> <HomeFeed homeFeed={homeFeed} isLoading={isHomeFeedLoading} />
            </div>
        </div>
    );
}
