 ...
 * @param options.MetaData - An optional boolean. If `true`, only the metadata (title, file name, and highest quality video links) of the video will be returned, without downloading or streaming. This parameter cannot be used with `Stream`, `Output`, `Filter`, or `ShowProgress`.
 ...
 * - If `MetaData` is `true`: An object containing `MetaData` (detailed video metadata), `FileName` (suggested file name), and `Links` (highest quality standard and HDR video formats).
