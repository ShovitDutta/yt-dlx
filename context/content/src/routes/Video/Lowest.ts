...
/**
 * @summary Downloads or streams the lowest quality video from YouTube, with optional filtering and metadata retrieval.
 *
 * This function retrieves the lowest available quality video stream from a given YouTube query (URL or video ID).
 ...
 */
export default async function Video_Lowest({
    Query,
    Output,
    UseTor,
    Stream,
