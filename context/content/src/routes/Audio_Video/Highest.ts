 ...
 */
export default async function AudioVideoHighest({ Query, Output, UseTor, Stream, Filter, MetaData, Verbose, ShowProgress, AudioLanguage }: AudioVideoHighestOptions): Promise<
    | {
