...
/**
 * @summary Downloads or streams a YouTube video with the highest available audio and video quality, with optional filtering and metadata retrieval.
 *
 * This function retrieves the highest available quality video stream and the highest available quality audio stream (by default or specified language) from a given YouTube query (URL or video ID).
