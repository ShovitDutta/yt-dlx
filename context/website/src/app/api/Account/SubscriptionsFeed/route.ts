...
export async function GET(req: NextRequest) {
    try {
        ...
        // Call the YouTubeDLX.Account.SubscriptionsFeed function to get subscriptions feed data
        const result = await YouTubeDLX.Account.SubscriptionsFeed({ cookies: cookies });
